...
<body>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                    <a class="nav-link" href="detail.php?id=<?php echo $_GET['id']?>">Detail<span class="sr-only">(current)</span></a>
                </li>
            </ul>
    ...
    if (isset($_POST['add'])) {
        $app = new Application();
        $app->updateGuideById($_GET['id'], $_POST['title'], $_POST['description']);
    ...
    <form class="col-6 container-fluid content-section" method="post" id=form enctype="multipart/form-data">
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="title" value="<?php echo $guide['title'] ?>" required>
        </div>
        <div class="form-group">
            <label for="exampleInputPassword1">Popis</label>
            <textarea class="form-control text-input" name="description" rows="5" required><?php echo $guide['description'] ?></textarea>
        </div>
        <div class="form-group">
        ...
        <input type="submit" class="btn btn-primary" name="add" value="Upraviť">
    </form>
